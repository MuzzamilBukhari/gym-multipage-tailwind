  ...
  return (
    <div className="container mx-auto flex px-16 py-24 md:flex-row flex-col items-center ">
      ...
      <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 pr flex flex-col md:items-start md:text-left items-center text-center">
        <h1 className="title-font sm:text-5xl text-8xl mb-4 font-black  text-white">
          Why
        ...
        <div className="flex justify-center items-center">
          <button className="inline-flex text-lg font-medium text-white border-0 px-6 focus:outline-none py-[2px] ml-3 bg-black  border-none shadow-primary ring-2 ring-primary shadow-md rounded-lg hover:scale-105 transform transition duration-300">
